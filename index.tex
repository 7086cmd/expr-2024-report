...
\author{陈麒泽\ 20231204 \and 胡铭轩\ 20231207 \and 卢柯忻\ 20230534 \and 吴承宇\ 20230616 \\ \texttt{<7086cmd@gmail.com>} \and 张函毓\ 20231237 \and 章嘉乐\ 20231226 \thanks{Euqal contribution.}}
\date{\today}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.8]
        ...
        \draw (1, 4) parabola bend (1, 4) (8, 0);
    \end{tikzpicture}
    \caption{``魔板'' 示意图}
